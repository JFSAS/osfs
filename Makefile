...
CFLAGS		= -I include/ -I include/sys/ -c -fno-builtin -m32 -fno-pie
...
OBJS		= kernel/kernel.o kernel/start.o kernel/main.o\
			...
			lib/syslog.o\
			mm/main.o mm/forkexit.o mm/exec.o mm/proc_search.o\
...
LOBJS		=  lib/syscall.o\
			...
			lib/dir_search.o lib/proc_search.o lib/kill.o lib/vim.o
...
lib/dir_search.o: lib/dir_search.c
	$(CC) $(CFLAGS) -o $@ $<

lib/proc_search.o: lib/proc_search.c
	$(CC) $(CFLAGS) -o $@ $<
...
mm/proc_search.o: mm/proc_search.c
	$(CC) $(CFLAGS) -o $@ $<
...
fs/dir_search.o: fs/dir_search.c
	$(CC) $(CFLAGS) -o $@ $<
